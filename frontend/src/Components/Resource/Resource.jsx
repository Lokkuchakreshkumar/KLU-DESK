 ...
 RENDER_URI= import.meta.env.VITE_RENDER_URI
  ...
  return (
    <div className='bluespotlight min-h-screen'>
      <Helmet>
        <title>Academic Resources | Kled by Chakresh</title>
        <meta name="description" content="Find all your academic materials for your specific year and semester on Kled. This platform, created by KL University's own Chakresh, provides easy access to downloadable previous year question papers, notes, and important questions to help you excel in your studies." />
      </Helmet>
