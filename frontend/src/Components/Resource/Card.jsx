...
const handlepreview = ()=>{
  ...
  return (
    <div className='flex flex-col rounded-2xl m-8 items-start  justify-start border bg-[#14274A] border-black p-8'>
...
<button className='w-full border border-cyan-500 mt-4 p-4 text-white rounded-2xl hover:bg-cyan-500 hover:cursor-pointer hover:shadow-xl hover:shadow-cyan-500/50'>Downlaod in Drive</button>
    </div>
  )
}
