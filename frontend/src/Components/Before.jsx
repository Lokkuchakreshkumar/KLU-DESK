...
export default function Before(){
    return(
        ...
        <a href="#resource" className="bg-amber-400 p-4 hover:shadow-xl hover:shadow-amber-500/50  my-4   rounded-3xl">Get Started<FaArrowRight className="inline ml-4"/></a>
