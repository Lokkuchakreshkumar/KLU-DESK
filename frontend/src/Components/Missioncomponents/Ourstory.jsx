...
const Ourstory = () => {
  return (
    <div className='flex flex-col mt-12 sm:w-4/5 rounded-xl shadow-sm shadow-black p-8 bg-[#040C1D] items-center justify-center  border border-white'>
        <div className=' font-semibold bg-clip-text text-3xl text-transparent bg-linear-to-r from-sky-500 to-cyan-200 '>
            Our Story
        </div>
