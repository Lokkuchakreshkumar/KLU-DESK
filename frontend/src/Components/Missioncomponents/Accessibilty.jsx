...
const Accessibilty = () => {
  return (
    <div className="flex w-full sm:w-1/2 flex-col mt-4  items-center justify-center">
        <div className='flex w-[20%] sm:w-[8%] justify-center py-6 shadow-lg shadow-black items-center bg-neutral-900 border border-white/30  rounded-xl  text-amber-400'>
